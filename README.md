...
[polymind.chat](https://polymind.chat)

**Zola** is the open-source chat interface for all your models.

![polymind cover](./public/cover_polymind.jpg)
...
```bash
git clone https://github.com/ibelick/polymind.git
cd polymind
npm install
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/ibelick/polymind)
